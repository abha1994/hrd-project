...
class Admin_institute extends Model
{
	...
	public static function delete_data($id){
		...
		if(!empty($id)){
			...
			$insertRecord['fellowship_period_to']=$fetchRecord[0]->fellowship_period_to;
	 ...
	 public static function pendingInst($frmDate=null,$toDate=null,$stateId=null,$courseId=null){
		...
		->leftJoin('user_credential', 'user_credential.id', '=', 'institute_details.user_id')
		->leftJoin('registration', 'user_credential.registeration_id', '=', 'registration.candidate_id')
		->select('registration.institute_name','registration.institute_addres','registration.institute_reg_no','registration.pincode','registration.statecd','registration.category_id','registration.email_id','registration.mobile_no','institute_details.user_id','institute_details.institute_id','institute_details.department_name','institute_details.application_cd','institute_details.coordinate_prog','institute_details.institute_type_id','institute_details.university_rank','institute_details.year_establishment','institute_details.any_collaboration','institute_details.research_phd','institute_details.energy_experience','institute_details.course_start_date','institute_details.specialization_offered','institute_details.industry_collaboration','institute_details.placement_details','institute_details.other_details','institute_details.spon_project','institute_details.fellowship_mtech','institute_details.fellowship_jrf','institute_details.fellowship_srf','institute_details.fellowship_msc','institute_details.fellowship_total','institute_details.fellowship_period','institute_details.fellowship_period_to','institute_details.certified_status','institute_details.annual_report','institute_details.final_submit','institute_details.faculty_details','institute_details.placement_details','institute_details.file_prevStudent_proof','institute_details.file_upload_signature','institute_details.status_id','institute_details.officer_role_id');
	...
	//echo "<pre>"; print_r($data['institute_details']); die;
		...
		'special_offer'=>  "B) Specialization offered",
		'indus_collab'=>"C) If any industry collaboration is there, if so details thereof",
		'placement_prov'=>  "D) If placement service is being provided",
		'any_details'=>  "E ) Any other details",
		'spon_project'=>  "Sponsored Projects in the area of Energy, Environment and Renewable Energy",
		'fellow_period'=>  "Fellowship slot requirement Period From",
		'fellow_period_to'=>  "Fellowship slot requirement Period To",
		'mtech'=>  "M.Tech.",
		'jrf'=>  "JRF",
		'srf'=>  "SRF",
		...
		$data['internship_export'][$i]['date_start'] = date('d-m-Y',strtotime($value->course_start_date));
		...
		$data['internship_export'][$i]['fellow_period_to'] = $value->fellowship_period_to;
