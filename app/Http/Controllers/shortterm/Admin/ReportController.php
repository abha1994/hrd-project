...
class ReportController extends Controller
{
	...
	public function getadminshorttermreport(Request $request)
	{
		...
		if($val2!=""){
			$v = DB::table('short_term_program')->where('short_term_id',$val2)->get(array('utilization_cetificate_doc','audited_statement_doc','programme_completion_doc','impact_tranning'))->first();
			// dd($data);
