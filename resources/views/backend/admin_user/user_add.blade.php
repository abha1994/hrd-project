						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6 input-group date" data-provide="datepicker">
									<input type="text"  class="form-control @error('joining_date') is-invalid @enderror" value="{{ old('joining_date') }}"  placeholder="Joining Date*" name="joining_date" id="joining_date">
									<div class="input-group-addon">
								        <span class="glyphicon glyphicon-th"></span>
								    </div>
									@error('joining_date')
								...
								<div class="col-md-6 input-group date" data-provide="datepicker">
									<input type="text"  class="form-control @error('transfer_date') is-invalid @enderror" value="{{ old('transfer_date')}}"  placeholder="Transfer Date*" name="transfer_date" id="transfer_date">
									<div class="input-group-addon">
								        <span class="glyphicon glyphicon-th"></span>
								    </div>
									@error('transfer_date')
