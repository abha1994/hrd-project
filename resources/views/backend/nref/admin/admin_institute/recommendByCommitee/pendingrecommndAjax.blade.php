...
$data1[] = array(
			...
			"remarks"=>'-',
			"clickTocheck"=>'<a href="'.route('edit-university',$inst->institute_id ).'#universitySelected"><i class="fa fa-edit"></i></a>
			<a href="'.route('view-recommendCommite',$inst->institute_id ).'"><i class="fa fa-eye"></i></a>
