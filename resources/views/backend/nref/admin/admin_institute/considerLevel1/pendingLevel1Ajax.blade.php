...
$data1[] = array(
			...
			"clickTocheck"=>'<a href="'.route('edit-university',$inst->institute_id ).'#universityCons"><i class="fa fa-edit"></i></a>
			<a href="'.route('view-level1university',$inst->institute_id ).'"><i class="fa fa-eye"></i></a>
