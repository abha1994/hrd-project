...
<script>
    var page_url = "{{ url('pendingInstituteAjax') }}";
</script>
    ...
    <div class="container-fluid">
	 ...
	 <form action="{{ route('exportPdf') }}" class=""  autocomplete="off" method="POST">
			<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
			 ...
			 <input type="hidden" name="institutetype" value="1" >
              ...
              <tbody>
				...
				<?php $i=1; foreach($data['institute_data'] as $v){?>
				  ...
				  <br>
				      ...
				      <a href="{{route('edit-university',$v->institute_id )}}#university"><i class="fa fa-edit"></i></a>
					  @endcan
