...
<script>
    var page_url = "{{ url('nonconsiderInstituteAjax') }}";
</script>
    ...
    <div class="container-fluid">
	 ...
	 <form action="{{ route('exportPdf') }}" class=""  autocomplete="off" method="POST">
			<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
			 ...
			 <input type="hidden" name="institutetype" value="3" >
              ...
              <tbody>
				...
				<?php $i=1; foreach($data['institute_data'] as $v){?>
				  ...
				  <br>
					  ...
					  @can('rejected-nref-institute-edit')		
				      <a href="{{route('edit-university',$v->institute_id )}}#universityNocons"><i class="fa fa-edit"></i></a>
					  @endcan
				      @can('rejected-nref-institute-list')
					  <a href="{{route('view-rejctlist',$v->institute_id )}}"><i class="fa fa-eye"></i></a>
				      @endcan
					  @can('rejected-nref-institute-delete')
