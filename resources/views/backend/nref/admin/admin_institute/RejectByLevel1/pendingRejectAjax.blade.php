...
$data1[] = array(
			...
			"clickTocheck"=>'<a href="'.route('edit-university',$inst->institute_id ).'#universityNocons"><i class="fa fa-edit"></i></a>
			<a href="'.route('view-rejctlist',$inst->institute_id ).'"><i class="fa fa-eye"></i></a>
