...
<div class="container-fluid">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">View selected student</li>
      </ol>
  <div class="card card-login mx-auto mt-5 ">     
   <div class="card-header text-center"><h4 class="mt-2">NREF/{{date('Y')}}/{{$recorde->id}}</h4></div>
      ...
      <div class="card-body">
		...
		<?php } ?>    
            <a class="btn btn-secondary" href="{{url('admin-student-final-selected/'.$ids)}}">Back</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="hidden" name="redirect_url" value="admin-student-committee-rec">
