...
<div class="container-fluid">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">View Final Rejected Student</li>
      </ol>
  <div class="card card-login mx-auto mt-5 ">     
   <div class="card-header text-center"><h4 class="mt-2">NREF/{{date('Y')}}</h4></div>
      ...
      <div class="card-body">
            ...
            <a class="btn btn-secondary" href="{{url('admin-student-final-rejected/'.$ids)}}">Back</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width: 109%;">
      <div class="modal-header">
         ...
         <div class="card-header text-center" style="width: 100%;"><h4  class="application_id mt-2"> </h4><button type="button" class="close" onclick="close_consider_non_cons()" style="margin-top:-47px">&times;</button></div>
