      ...
      <div class="col-md-10">
        <div class="card card-primary card-outline">
          <div class="card-body">              
            ...
            action="{{ route('short-term-program.update',$record->short_term_id) }}" 
           ...
           <input type="hidden" name="_method" value="PUT">
            ...
            <div class="form-group{{ $errors->has('name_proposed_training_program') ? ' has-error' : '' }}">
              <div class="row">
                  ...
                  <input name="name_proposed_training_program" id="name_proposed_training_program" class="form-control required" value="{{$record->name_proposed_training_program}}" placeholder="Name of the proposed training program" /> 
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control  required"   value="{{$record->coordinator_name}}" id="coordinator_name" placeholder="Coordinator Name*" name="coordinator_name"  >
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input name="coordinator_mobile" id="coordinator_mobile"  value="{{$record->coordinator_mobile}}"  class="form-control required" type="text" id="coordinator_mobile"  class="form-control required" placeholder="Coordinator Mobile" maxlength="10" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"> 
                ...
                <div class="col-md-6">
                  ...
                  <textarea name="coordinator_address" id="coordinator_address" class="form-control required">{{$record->coordinator_address}}</textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input name="history_organization_doc "  value="{{ $record->history_organization_doc }}"  class="form-control" type="file" id="history_organization_doc"  class="form-control" > 
                ...
                <p id="history_organization_doc_error"></p> 
                <?php if(!empty($record->history_organization_doc)){ ?>
                <a href="{{asset('public/uploads/nref/short_term/'.$record->history_organization_doc)}}">Download</a>     <?php } ?>
                <input type="hidden" name="history_organization_doc" value="{{$record->history_organization_doc }}">
                </div>
                <div class="col-md-6">
                  ...
                  <select name="technology_area" id="technology_area" class="form-control" required="required" onchange="showfield(this.options[this.selectedIndex].value)">                    
                    ...
                    <option value="1"  @if ($record->technology_area == 1) {{ 'selected' }} @endif> Solar </option>
                    <option value="2"  @if ($record->technology_area == 2) {{ 'selected' }} @endif> Solar Thermal </option>
                    <option value="3"  @if ($record->technology_area == 3) {{ 'selected' }} @endif> Solar Rooftop  </option>
                    <option value="4"  @if ($record->technology_area == 4) {{ 'selected' }} @endif> Solar Water Pumping </option>
                    <option value="5"  @if ($record->technology_area == 5) {{ 'selected' }} @endif> Small Hydro </option>
                    <option value="6"  @if ($record->technology_area == 6) {{ 'selected' }} @endif> Bioenergy </option>
                    <option value="7"  @if ($record->technology_area == 7) {{ 'selected' }} @endif> Hydrogen </option>
                    <option value="8"  @if ($record->technology_area == 8) {{ 'selected' }} @endif> Wind Energy  </option>
                    <option value="9"  @if ($record->technology_area == 9) {{ 'selected' }} @endif> Other RE Area  </option>
                  </select>
                 ...
                 @endif
                 <div id="other_re_area" style="margin-top: 15px;"><textarea name="other_re_area" class="form-control">{{ $record->other_re_area }}                 
                 </textarea></div>
              ...
              <div class="row">
                <div class="col-md-6">
                 ...
                 <textarea class="form-control required" name="objective_program" id="objective_program">{{ $record->objective_program }}</textarea>
                ...
                <div class="col-md-6"><label>Target group to be addressed in proposed training program  </label>     
                 ...
                 <textarea class="form-control required" name="target_group" id="target_group" >{{ $record->target_group }}</textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text"  class="form-control required" name="geographical_area"  id="geographical_area" placeholder="Geographical area of operation " rows="1" value="{{$record->geographical_area}}"  > 
                ...
                <div class="col-md-6"><label>Assessment Skilled  </label>
                 ...
                 <textarea name="assessment_skilled" id="assessment_skilled" class="form-control required">{{ $record->assessment_skilled }}</textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="objective_program">Number of trainees proposed to be trained in one year (this should be based on assessment done in the area of operation)(Numeric Value)</label>

                  <input type="text"  class="form-control required" name="no_student_trained_a_year"  id="no_student_trained_a_year" placeholder="Number of trainees proposed to be trained in one year" rows="1" onkeypress="return IsNumeric(event);" value="{{ $record->no_student_trained_a_year }}"> 
                ...
                <div class="col-md-6"><label>No. of training programmers proposed in one years  </label>
                  ...
                  <input type="text" class="form-control required" name="proposed_programme_a_year"  id="proposed_programme_a_year" rows="1" placeholder="No. of training programmers proposed in one years"  onkeypress="return IsNumeric(event);" value="{{ $record->proposed_programme_a_year }}" > 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text"  class="form-control required" name="no_trainee_proposed_batch"  id="no_trainee_proposed_batch" placeholder="Number of trainees proposed to be trained in one year" rows="1"  onkeypress="return IsNumeric(event);" value="{{ $record->no_trainee_proposed_batch }}"> 
                ...
                <div class="col-md-6"><label>Duration of the proposed course </label>
                  ...
                  <input type="text" class="form-control required" name="duration_proposed_course"  id="duration_proposed_course" rows="1" placeholder="Duration of the proposed course" value="{{ $record->duration_proposed_course }}" > 
              ...
              <div class="row">
                <div class="col-md-12">
                 ...
                 <textarea name="selection_criteria" id="selection_criteria" class="form-control required">{{$record->selection_criteria }}</textarea>
...
<!---------------------------- 2 Page---------------------------------->
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="texgt" class="form-control required" name="faculty_name"  id="faculty_name" placeholder="Faculty Name" value="{{$record->faculty_name }}" />  
                ...
                <div class="col-md-6"><label>Faculty Designation </label>
                  ...
                  <input type="text" class="form-control required" name="faculty_designation"  id="faculty_designation" rows="1" placeholder="Faculty Designation" value="{{ $record->faculty_designation }}"  > 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control required" name="faculty_level"  id="faculty_level" placeholder="Faculty Level" value="{{ $record->faculty_level }}"  />  
                ...
                <div class="col-md-6"><label>Infrastructure  </label>
                  ...
                  <textarea name="infrastructure" id="infrastructure" class="form-control required">{{ $record->infrastructure }}</textarea>
              ...
              <div class="row">
                <div class="col-md-6"> 
                  ...
                  <input type="file" class="form-control" name="course_material_doc"  id="course_material_doc" placeholder="Course Material doc" value="{{ $record->course_material_doc }}" />  
                  <input type="hidden" name="course_material_doc" value="{{ $record->course_material_doc }}">
                   @if ($errors->has('course_material_doc'))
                  <span class="help-block">
                      <strong>{{ $errors->first('course_material_doc') }}</strong>
                  </span>
                 @endif
                 <label style="color:#FF0000; font-size:11px;"> (File Format accepts: PDF &amp; Maximum Size: 5MB) <br>
                <p id="course_material_doc_error"></p> 
                <?php if(!empty($record->course_material_doc)){ ?>
                <a href="{{asset('public/uploads/nref/short_term/'.$record->course_material_doc)}}">Download</a>     <?php } ?>
                <input type="hidden" name="history_organization_doc" value="{{$record->course_material_doc }}">
                </div>
                <div class="col-md-6"><label>Methodology of imparting training </label>
                  ...
                  <select name="methodology_imparting_training" id="methodology_imparting_training" class="form-control required">
                    <option value="">Select</option>
                    <option value="1"  @if ($record->methodology_imparting_training == 1) {{ 'selected' }} @endif>Theory</option>
                    <option value="2"  @if ($record->methodology_imparting_training == 2) {{ 'selected' }} @endif>Practical</option>
                    <option value="3"  @if ($record->methodology_imparting_training == 3) {{ 'selected' }} @endif>Both</option>
                   </select>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="file" class="form-control" name="guest_faculty_doc"  id="guest_faculty_doc" placeholder="Guest Faculty Doc" value="{{ $record->guest_faculty_doc }}" />  
                  <input type="hidden" name="guest_faculty_doc" value="{{ $record->guest_faculty_doc }}">
                 ...
                 @endif
                  <label style="color:#FF0000; font-size:11px;"> (File Format accepts: PDF &amp; Maximum Size: 5MB) <br>
                  <p id="guest_faculty_doc_error"></p> 
                  <?php if(!empty($record->guest_faculty_doc)){ ?>
                  <a href="{{asset('public/uploads/nref/short_term/'.$record->guest_faculty_doc)}}">Download</a>     <?php } ?>
                  <input type="hidden" name="guest_faculty_doc" value="{{$record->guest_faculty_doc }}">
                </div>
                <div class="col-md-6"><label>Content Letter doc  </label>

                  <input type="file" class="form-control" name="content_letter_doc"  id="content_letter_doc" placeholder="Content Letter doc"   value="{{ $record->content_letter_doc }}" />  
                  <input type="hidden" name="content_letter_doc" value="{{ $record->content_letter_doc }}">
                 ...
                 @endif
                  <label style="color:#FF0000; font-size:11px;"> (File Format accepts: PDF &amp; Maximum Size: 5MB) <br>
                  <p id="content_letter_doc_error"></p> 
                  <?php if(!empty($record->content_letter_doc)){ ?>
                  <a href="{{asset('public/uploads/nref/short_term/'.$record->content_letter_doc)}}">Download</a>     <?php } ?>
                  <input type="hidden" name="content_letter_doc" value="{{$record->content_letter_doc }}">
                </div>
              </div> 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <textarea name="core_guest_percentage_time" id="core_guest_percentage_time" class="form-control required">{{ $record->core_guest_percentage_time }}</textarea>
                ...
                <div class="col-md-6"><label>Tie up campus programmer  </label>
                    ...
                    <textarea name="tieup_campus_programmer" id="tieup_campus_programmer" class="form-control required">{{ $record->tieup_campus_programmer }}</textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <textarea name="engaging_trained_programmer" id="engaging_trained_programmer" class="form-control required">{{ $record->engaging_trained_programmer }}</textarea>
                ...
                <div class="col-md-6"><label>Fee charged traniees  </label>
                  ...
                  <textarea name="fee_charged_traniees" id="fee_charged_traniees" class="form-control required">{{ $record->fee_charged_traniees }}</textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                 ...
                 <textarea name="anticipated_impact" id="anticipated_impact" class="form-control required">{{ $record->anticipated_impact }}</textarea>
                ...
                <div class="col-md-6"><label>Financial Proposal doc  </label>
                   ...
                   <input type="file"  class="form-control" name="financial_proposal_doc"  id="financial_proposal_doc" value="{{ $record->financial_proposal_doc }}" /> 
                   <input type="hidden" name="financial_proposal_doc" value="{{ $record->financial_proposal_doc }}">
                 ...
                 @endif
                 <label style="color:#FF0000; font-size:11px;"> (File Format accepts: PDF &amp; Maximum Size: 5MB) <br>
                  <p id="financial_proposal_doc_error"></p> 
                  <?php if(!empty($record->financial_proposal_doc)){ ?>
                  <a href="{{asset('public/uploads/nref/short_term/'.$record->financial_proposal_doc)}}">Download</a>     <?php } ?>
                  <input type="hidden" name="financial_proposal_doc" value="{{$record->financial_proposal_doc }}">  
