              ...
              @foreach ($records as $record)
                <tr>
                  ...
                  <td>{{ $record->coordinator_mobile }}</td>
                   <td><a class="btn btn-info" href="{{ route('short-term-program.show',$record->short_term_id) }}" style="color: white">Show</a>
                    @if(empty($record->signature_doc))
                    <a class="btn btn-success" href="{{ route('short-term-program.edit',$record->short_term_id) }}">Edit</a>
                    @endif
                   </td>
                </tr>
              @endforeach
