...
@section('container')
 ...
 <div class="content-wrapper">
	...
	<form enctype="multipart/form-data" action="{{ url('st-bank-form-post-final/'.$id) }}" autocomplete="off" id="bankmandate_form" method="POST" >
			{!! csrf_field() !!}
								...
								<a href="{{ route('st-pdfview',['download'=>'pdf','id'=>$id]) }}">
							...
							<center>
								...
								<a href="{{url('/st-bank-details')}}" class="btn btn-primary buttonEvent"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp; Back</a>
								</div> 
							</center>
