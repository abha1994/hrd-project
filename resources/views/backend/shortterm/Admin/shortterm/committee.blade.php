 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Forward to committee Application
		 </li>
      </ol>
	 
      <!-- Example DataTables Card-->
    <div class="card mb-3">
		<div class="card-header text-center"><h4 class="mt-2">Forward to committee Application</h4></div>
		...
		@endif
		<a href="{{url('forward-to-committee-short-term')}}" class="btn btn-secondary">Back</a>
