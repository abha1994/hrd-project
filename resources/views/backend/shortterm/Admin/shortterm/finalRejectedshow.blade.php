 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Final Rejected</li>
      </ol>
	 
      <!-- Example DataTables Card-->
    <div class="card mb-3">
		<div class="card-header text-center"><h4 class="mt-2"> Final Rejected </h4></div>
...
<!--             <button type="button" class="btn btn-primary" data-toggle="modal"  style="border: #d81a11;background-color: #d81a11; " onclick="considered_nonconidered(2,'<?php echo $record[0]->short_term_id;?>')">Non Considered</button>
        ...
        @endif
        @if($roleid->role==2)
		<!-- <button type="button" class="btn btn-primary" data-toggle="modal" style="border: #3c8424;background-color: #3c8424;" onclick="considered_nonconidered(1,'<?php echo $record[0]->short_term_id;?>' )">Forward to Committee</button> -->
		<!-- <button type="button" class="btn btn-primary" data-toggle="modal"  style="border: #d81a11;background-color: #d81a11; " onclick="considered_nonconidered(2,'<?php echo $record[0]->short_term_id;?>')">Non Considered</button> -->
           
        @endif
		<a href="{{url('final-rejected')}}" class="btn btn-secondary">Back</a>
