...
<div class="content-wrapper">
    ...
    <!-- Filter Code Start -->
		...
		<input type="hidden" name="institutetype" id="institutetype" value="4" >
              ...
              @foreach ($records as $record)
                <tr>
                  ...
                  <td>{{ $record->coordinator_mobile }}</td>
                   <td><a class="btn btn-info" href="{{ url('forward-committee/'.$record->short_term_id) }}" style="color: white">Show</a>
