...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Consider By Level1 Application
     </li>
      </ol>
   
      <!-- Example DataTables Card-->
      <div class="card mb-3">
      <div class="card-header text-center"><h4 class="mt-2">Consider By Level1 Application  </h4></div>
     ...
     <!-- Filter Code Start -->
		...
		<input type="hidden" name="institutetype" id="institutetype" value="2" >
