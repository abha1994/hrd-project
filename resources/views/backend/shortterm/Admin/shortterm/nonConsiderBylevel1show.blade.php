 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Rejected  By Level 1 Application</li>
      </ol>
	 
      <!-- Example DataTables Card-->
    <div class="card mb-3">
		<div class="card-header text-center"><h4 class="mt-2">Rejected  By Level 1 Application </h4></div>
       ...
       <button type="button" class="btn btn-primary" data-toggle="modal"  style="border: #d81a11;background-color: #d81a11; " onclick="considered_nonconidered(2,'<?php echo $record[0]->short_term_id;?>')">Non Considered</button>
		...
		@endif
		@endif
		<a href="{{url('nonconsider-by-level1')}}" class="btn btn-secondary">Back</a>
