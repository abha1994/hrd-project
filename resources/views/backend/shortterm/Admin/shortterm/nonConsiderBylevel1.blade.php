...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Rejected By Level1 Application
     </li>
      </ol>
   
      <!-- Example DataTables Card-->
      <div class="card mb-3">
      <div class="card-header text-center"><h4 class="mt-2">Rejected By Level1 Application  </h4></div>
     ...
     <!-- Filter Code Start -->
		...
		<input type="hidden" name="institutetype" id="institutetype" value="3" >
              ...
              @foreach ($records as $record)
                <tr>
                  ...
                  <td>{{ $record->coordinator_mobile }}</td>
                   <td><a class="btn btn-info" href="{{ url('nonconsider-by-level1',$record->short_term_id) }}" style="color: white">Show</a>
