...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
      <div class="card-header text-center"><h4 class="mt-2">Recommend By  Committee Application </h4></div>
              ...
              @foreach ($records as $record)
                <tr>
                  ...
                  <td>{{ $record->coordinator_mobile }}</td>
                   <td><a class="btn btn-info" href="{{ url('recoment-committee/'.$record->short_term_id) }}" style="color: white">Show</a>
