...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Final Rejected
     </li>
      </ol>
   
      <!-- Example DataTables Card-->
      <div class="card mb-3">
      <div class="card-header text-center"><h4 class="mt-2">Final Rejected Application </h4></div>
    ...
    <!-- Filter Code Start -->
		...
		<input type="hidden" name="institutetype" id="institutetype" value="7" >
              ...
              @foreach ($records as $record)
                <tr>
                  ...
                  <td>{{ $record->coordinator_mobile }}</td>
                   <td><a class="btn btn-info" href="{{ url('final-rejected-view/'.$record->short_term_id) }}" style="color: white">Show</a>
